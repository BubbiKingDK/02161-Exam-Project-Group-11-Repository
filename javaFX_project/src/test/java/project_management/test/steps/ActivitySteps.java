...
public class ActivitySteps {
	...
	public void thereIsAPersonalActivityWithTheNameAStartDateWeekAndAnEndDateWeek(String name, int startWeek,
			int endWeek) {
	...
	public void thereIsAnActivityWithTheNameAStartDateWeekAndAnEndDateWeekInTheProjectWithTheSerialNumber(
			String activityName, int startWeek, int endWeek, int serialnumber) throws OperationNotAllowedException {
	...
	public void the_activity_with_the_name_a_start_date_week_and_an_end_date_week_is_added_to_the_project_with_serial_number(
			String name, int startWeek, int endWeek, int serialNumber) throws OperationNotAllowedException {
	...
	public void theActivityWithTheNameIsAlreadyInTheProjectWithSerialNumber(String name, int serialNumber)
			throws OperationNotAllowedException {
	...
	public void theActivityWithNameIsAddedToTheUserWithID(String activityName, String ID)
			throws OperationNotAllowedException {
		try {
	...
	public void theActivityWithTheNameAStartDateWeekAndAnEndDateWeekIsAddedToTheUserWithID(String activityName,
		...
		PersonalActivity activity = projectManagementApp.findPersonalActivity(activityName,
	...
	public void theActivityWithTheNameIsAlreadyAssignedToTheUserWithID(String activityName, String ID)
			throws OperationNotAllowedException {
	...
	public void thereIsNotAnActivityWithTheNameAStartDateWeekAndAnEndDateWeekInTheProjectWithTheSerialNumber(
			String activityName, int startWeek, int endWeek, int serialNumber) throws OperationNotAllowedException {
		assertEquals(
	...
	public void theUserGetsTheListOfEmployeesForTheActivityWithTheNameInTheProjectWithSerialNumber(String activityName,
			int serialNumber) {
		try {
			projectManagementApp.getEmployeesInActivity(projectManagementApp.findProjectActivity(activityName,
	...
	public void thereIsAnAlreadyAnActivityWithTheNameAStartDateWeekAndAnEndDateWeekAddedToTheUserWithID(
			String activityName, int startWeek, int endWeek, String ID) throws OperationNotAllowedException {
	...
	public void theUserTriesToFindTheActivityWithNameInTheProjectWithSerialNumber(String activityName, int serialNumber)
			throws OperationNotAllowedException {
		try {
			projectActivity = projectManagementApp.findProjectActivity(activityName,
					projectManagementApp.findProject(serialNumber));
		} catch (OperationNotAllowedException e) {
			errorMessage.setErrorMessage(e.getMessage());
		}
	...
	public void theActivityWithNameAStartDateWeekAndAnEndDateWeekInTheProjectWithSerialNumberIsFound(
			String activityName, int startWeek, int endWeek, int serialNumber) {
