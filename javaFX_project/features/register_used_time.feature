...
Scenario: Correct combined work hours
	...
	Then the total work hours of the activity with the name "Scrum-Meeting", a start date week 3 and an end date week 4 in the project with the serial number 24001, is 14.0
