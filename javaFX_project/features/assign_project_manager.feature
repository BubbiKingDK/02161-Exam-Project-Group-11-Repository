...
Scenario: Register a project manager
	...
	And an employee with ID "karl" is registered with the project with serial number 24001
...
Scenario: Can not register a project manager that is not registered with the project
	Given that there is a project with serial number 24001
	And an employee with ID "karl" is not registered with the project with serial number 24001
	When the user assigns the project manager with ID "karl" to the project with serial number 24001
...
Scenario: An employee assigns a new project manager to a project with an existing project manager 
	Given that there is a project with serial number 24001
	And an employee with ID "karl" is registered with the project with serial number 24001
	And an employee with ID "bjar" is registered with the project with serial number 24001
